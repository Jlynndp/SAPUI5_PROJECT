		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#logaligroupsapui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupsapui5app-display": {
								"semanticObject": "logaligroupsapui5app",
								"action": "display",
								"description": "Gestión Empleados",
								"title": "Gestión Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.sapui5app",
									"url": sap.ui.require.toUrl("logaligroup/sapui5app")
								}
							}
						}
					}
