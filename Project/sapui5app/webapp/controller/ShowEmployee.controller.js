    ...
    function (JSONModel, Controller, Filter, FilterOperator, MessageBox, MessageToast, History) {
        ...
        return Controller.extend("logaligroup.sapui5app.controller.ShowEmployee", {
            onInit: function () {
                ...
                this.getOwnerComponent().getRouter().getRoute("RouteShowEmployee").attachPatternMatched(this.resetView, this);    
            },
            ...
            onSavePromotion: function () {
                ...
                if (salaryModel.Amount && salaryModel.CreationDate && salaryModel.Comments) {
                    ...
                    //save promotion: “/sap/opu/odata/sap/ZEMPLOYEES_SRV/Salaries”
